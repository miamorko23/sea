    ...
    try:
        ...
        with open('local_drowsiness_events.csv', mode='r') as file:
            ...
            for row in reader:
                ...
                cur.execute("""
                    INSERT INTO drowsinessevent (user_id, time, status)
                    VALUES (%s, %s, %s)
...
# record_drowsiness_event_local('C')  # Record a critical event locally

# After the drive is completed:
# upload_drowsiness_events_to_db('06cf876a081c2963bd79ad7890213cb5')
# ~~
...
# 06cf876a081c2963bd79ad7890213cb5
